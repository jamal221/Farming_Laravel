...
<div class="card-primary">
    <h3 class="card-title" style="align-items: end;">Water Resources Management</h3>
                ...
                @foreach($fetched_farms as $key => $value)
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn btn-success btn-xs add_water_resources" data-id={{ $value->FarmID}}>Define Water resources</button>
                        </td>
                    </tr>
                    @php
                        $count_row+=1
        ...
        var _token = $('input[name="_token"]').val();
            $(document).on('click', '.add_water_resources', function(){
                        ...
                        if(id2 != '' )
                        {
                            ...
                            if(!confirm("Would you like to define water resources to this farm")) {
                                return false;
                            }
                            try
                            {
                                url_change_content="{{route('regWaterResources', 'id_farm')}}";
